...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://IMovieme:IMovieme@imovieme.odkj7rs.mongodb.net/?retryWrites=true&w=majority&appName=IMovieme")
DATABASE_NAME = environ.get('DATABASE_NAME', "IMovieme")
